# -*- coding: utf-8 -*-
"""Email Sorter Python Application — Version 38.18
...
class EmailSorter:
    ...
    Version 38.18: See module docstring for full change list.
    """
    ...
    def save_smtp_cache(self) -> None:
        ...
        while not saved_successfully:
            try:
                ...
                self._inject_msip_label(tmp_path, tmp_path)
                shutil.move(tmp_path, self.smtp_cache_path)
