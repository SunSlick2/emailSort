...
class EmailSorter:
    ...
    def _load_config(self):
        ...
        try:
            ...
            required_top_level_keys = ['xls_path', 'smtp_cache_path', 'log_live_path', 'log_bulk_path', 'log_invalid_path', 'sheet_map']
    ...
    def save_smtp_cache(self) -> None:
        ...
        while not saved_successfully:
            try:
                ...
                self._inject_msip_label(tmp_path, tmp_path)        # label injected in-place
    ...
    def start_gui(self):
        ...
        root = tk.Tk()
        root.title("Email Sorter v38.13") # Updated title for version
