# -*- coding: utf-8 -*-
"""Email_Sorter_Python_Application_(Version_38_10_BossEmail_FromField_Only).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/SunSlick2/emailSort/blob/main/Email_Sorter_Python_Application_(Version_38_10_BossEmail_FromField_Only).ipynb
"""
...
class EmailSorter:
    ...
    Version 38.10: Modified BossEmail rule (Rule 10) to only check "From" (sender) field instead of all recipients
    """
    ...
    def process_email(self, outlook_namespace, mail, logger, folder_objects_map):
        ...
        8. ResearchEmail
        9. ResearchKeyword
        10. BossEmail (Only checks "From" sender field)
