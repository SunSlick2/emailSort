# -*- coding: utf-8 -*-
"""Email_Sorter_Python_Application_(Version_38_09_New_Rules_Added).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/SunSlick2/emailSort/blob/main/Email_Sorter_Python_Application_(Version_38_09_New_Rules_Added).ipynb
"""
...
class EmailSorter:
    ...
    Version 38.09: Added new rules - TradeKeyword, ResearchEmail, ResearchKeyword, BossEmail
                   Updated priority order according to sheet numbering in configv38.09.json
    """
    ...
    def process_email(self, outlook_namespace, mail, logger, folder_objects_map):
        ...
        try:
            ...
            # Rule 10: Email address in BossEmail
            if any(addr in self.boss_emails for addr in recipients):
                dest_folder_name = self.config['sheet_map']['BossEmail']['destination_name']
                mail.Move(folder_objects_map[dest_folder_name])
                self.log_email(logger, outlook_namespace, mail, "Matched by BossEmail", dest_folder_name)
                return True
    ...
    def start_gui(self):
        ...
        root = tk.Tk()
        root.title("Email Sorter v38.09") # Updated title for version
