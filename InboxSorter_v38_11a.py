# -*- coding: utf-8 -*-
"""Email_Sorter_Python_Application_(Version_38_11_ResearchEmail_Sender_Only).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/SunSlick2/emailSort/blob/main/Email_Sorter_Python_Application_(Version_38_11_ResearchEmail_Sender_Only).ipynb
"""
...
class EmailSorter:
    ...
    Version 38.11: Modified ResearchEmail rule (Rule 8) to only check "From" (sender) field
    """
    ...
    def start_gui(self):
        ...
        root = tk.Tk()
        root.title("Email Sorter v38.11") # Updated title for version
